...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.motorMax.setGeometry(QtCore.QRect(140, 50, 41, 20))
        self.motorMax.setObjectName("motorMax")
        self.label_3 = QtWidgets.QLabel(self.groupBox)
        self.label_3.setGeometry(QtCore.QRect(110, 30, 111, 21))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.motorMin.setGeometry(QtCore.QRect(140, 520, 41, 20))
        self.motorMin.setObjectName("motorMin")
        self.label_4 = QtWidgets.QLabel(self.groupBox)
        self.label_4.setGeometry(QtCore.QRect(110, 500, 111, 21))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.servoMax.setGeometry(QtCore.QRect(140, 50, 41, 20))
        self.servoMax.setObjectName("servoMax")
        self.label_8 = QtWidgets.QLabel(self.groupBox_2)
        self.label_8.setGeometry(QtCore.QRect(110, 30, 111, 21))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.servoMin.setGeometry(QtCore.QRect(140, 520, 41, 20))
        self.servoMin.setObjectName("servoMin")
        self.label_9 = QtWidgets.QLabel(self.groupBox_2)
        self.label_9.setGeometry(QtCore.QRect(110, 500, 111, 21))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.looseButton.setText(_translate("YourClassName", ""))
        self.readout.setHtml(_translate("YourClassName", """
            <html>
                <head/>
